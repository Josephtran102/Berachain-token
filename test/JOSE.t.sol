...
import {JOSEToken} from "../src/JOSE.sol";

contract JOSETokenTest is Test {
    // Variables
    JOSEToken public token;
    ...
    function setUp() public {
        ...
        token = new JOSEToken("JOSE Token", "JOS", 10000);
    }
    ...
    function test_name() public {
        assertEq(token.name(), "JOSE Token");
    }
